...
open class DownView: WKWebView {
     ...
     */
    public init(frame: CGRect, markdownString: String, openLinksInBrowser: Bool = true, templateBundle: Bundle? = nil, configuration: WKWebViewConfiguration? = nil, heightScale: CGFloat = 1, didLoadSuccessfully: DownViewClosure? = nil) throws {
